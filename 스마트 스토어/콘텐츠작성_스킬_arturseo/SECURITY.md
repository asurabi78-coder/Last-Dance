...
This repository contains a Claude Code skill — a set of markdown instructions that guide AI content generation. It does not contain executable code, API keys, or credentials.
...
- Instructions that could cause Claude to expose user credentials, API keys, or private data
- Prompt injection patterns embedded in templates or examples
- Content that could cause Claude to bypass safety guidelines
- References to external resources that have been compromised
