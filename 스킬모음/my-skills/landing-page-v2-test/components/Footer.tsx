        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-display font-bold">AppName</span>
            </a>
            <p className="text-gray-400 mb-6 max-w-sm">
              Transform your productivity with the ultimate mobile app for task
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    key={social.label}
                    href={social.href}
                    className="w-10 h-10 rounded-lg bg-gray-800 hover:bg-primary flex items-center justify-center transition-all hover:scale-110"
